...
public class UpgradeJavaCommerceOrderValidatorCheck extends BaseUpgradeCheck {
	...
	private static String _formatMethod(
		...
		javaMethodContent = StringUtil.replace(
			...
			StringUtil.replace(
				subjavaMethodContent, new String[] {_DEPRECATED_PARAMETER_NAME},
				new String[] {_DEPRECATED_PARAMETER_NAME + "Int"}, true));
		...
		javaMethodContent = StringUtil.replaceFirst(
			...
			StringBundler.concat(
				"{\n\n\t\tint ", _DEPRECATED_PARAMETER_NAME,
				"Int = quantity.intValue();"));

		return javaMethodContent;
	}

	private static final String _DEPRECATED_PARAMETER_NAME = "quantity";
