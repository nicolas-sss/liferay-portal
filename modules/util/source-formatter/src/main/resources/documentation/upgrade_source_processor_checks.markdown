...
UpgradeJavaGetCurrentCommerceAccountCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Replace 'getCurrentCommerceAccount' by 'getCurrentAccountEntry', and include new parameter |
