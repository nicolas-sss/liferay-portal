...
UpgradeJavaCommerceDestinationNamesCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | CommerceDestinationNames deprecated constants were replaced by DestinationNames constants |
