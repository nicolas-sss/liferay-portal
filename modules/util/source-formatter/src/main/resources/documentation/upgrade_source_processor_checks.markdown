...
UpgradeJavaFetchReferenceCodeMethodCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Reverse the order of the parameters 'company' and 'externalReferenceCode' of 'fetchCPInstanceByExternalReferenceCode' |
