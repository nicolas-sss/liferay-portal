...
UpgradeJavaGetCategoryIdMethodCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Replace the getLeftCategoryId method with getCategoryId of AssetCategory |
