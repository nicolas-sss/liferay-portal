...
UpgradeJavaCommerceOrderLocalServiceCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Fill the new parameters of the method `addCommerceOrder` of `CommerceOrderLocalService` and `CommerceOrderLocalServiceUtil` classes |
