...
UpgradeJavaGetCurrentCommerceAccountCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Replace 'getCurrentCommerceAccount' by 'getCurrentAccountEntry', and include new parameter |
