...
UpgradeJavaCommerceDestinationNamesCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | CommerceDestinationNames deprecated constants were replaced by DestinationNames constants |
