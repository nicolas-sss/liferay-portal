...
UpgradeJavaFetchReferenceCodeMethodCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Reverse the order of the parameters 'company' and 'externalReferenceCode' of 'fetchCPInstanceByExternalReferenceCode' |
