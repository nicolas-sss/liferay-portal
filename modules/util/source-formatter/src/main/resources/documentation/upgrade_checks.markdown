...
UpgradeJavaUpdateStatusMethodCheck | .bnd, .ftl, .gradle, .java, .jsp, .jspf or .vm | Fill the new parameter of the method `updateStatus` of 'UserLocalService', 'UserLocalServiceUtil', 'UserServiceUtil' and 'UserService' classes |
