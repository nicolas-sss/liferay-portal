...
- ### By File Extensions:
   ...
   - [.bnd, .ftl, .gradle, .java, .jsp, .jspf, .sass or .vm](src/main/resources/documentation/upgrade_source_processor_checks.markdown#checks-for-bnd-ftl-gradle-java-jsp-jspf-sass-or-vm)
