 ...
 */
@Generated("")
@GraphQLName(description = "bla bla bla", value = "TaxonomyCategoryProperty")
@JsonFilter("Liferay.Vulcan")
@Schema(description = "bla bla bla", requiredProperties = {"name"})
...
public class TaxonomyCategoryProperty implements Serializable {
	...
	@Schema(description = "The property's name.")
	...
	@GraphQLField(description = "The property's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	@NotEmpty
	...
	@Schema(description = "The property's value.")
	...
	@GraphQLField(description = "The property's value.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
