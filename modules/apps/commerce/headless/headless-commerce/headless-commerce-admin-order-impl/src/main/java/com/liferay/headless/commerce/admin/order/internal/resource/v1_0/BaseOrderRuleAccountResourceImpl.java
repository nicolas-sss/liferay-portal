...
public abstract class BaseOrderRuleAccountResourceImpl
	...
	@jakarta.ws.rs.Path("/order-rule-accounts/{orderRuleAccountId}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/order-rule-accounts/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/order-rules/{id}/order-rule-accounts")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/order-rules/order-rule-accounts/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
