...
public abstract class BaseProductConfigurationListResourceImpl
	...
	@jakarta.ws.rs.Path("/product-configuration-lists/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/product-configuration-lists/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/product-configuration-lists")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/product-configuration-lists/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:270427838