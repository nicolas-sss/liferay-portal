...
public abstract class BaseProductChannelResourceImpl
	...
	@jakarta.ws.rs.Path("/product-channels/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/product-channels/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/products/{id}/product-channels")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-812357194